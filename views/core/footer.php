  ...
  <div class="container p-4">
    <div class="row mt-4">
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-uppercase">See other cryptocurrencies</h5>

        <ul class="list-unstyled mb-0">
          <li>
            <a href="#!" class="text-white"><i class="fas fa-coins fa-fw fa-sm me-2"></i>Top cryptocurrencies</a>
          </li>
          <li>
            <a href="#!" class="text-white"><i class="fas fa-coins fa-fw fa-sm me-2"></i>All cryptocurrencies</a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled">
          <li>
            <a href="#!" class="text-white">The CryptoStore</a>
          </li>
          <li>
